upload_content = [
  ...
  { content = "Hello Pure! (created via our dynamic block)", file = "/terraform/test3.txt", executable = true },
  { content = "Hello Wold! (created via our dynamic block)", file = "/terraform/test4.txt", executable = true },
]
